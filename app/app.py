...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('SQLALCHEMY_DATABASE_URI', 'mysql+pymysql://root:1230@localhost/try')

migrate = Migrate(app, db)

app.config['PERMANENT_SESSION_LIFETIME'] = 31 * 24 * 60 * 60 # default is 31 days 
